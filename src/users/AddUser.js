...
export default function AddUser() {
    ...
    let navigate=useNavigate()
               ...
               const onSubmit=async(e)=>{
                    e.preventDefault();
                    await axios.post("http://localhost:9092/api/addStudents",user)
                    navigate("/")
               };
            ...
            <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
               ...
               <h2 className="text-center m-4">Register Student</h2> 
                ...
                <div className="mb-3">
                    ...
                    pattern="[a-zA-Z]{3,13}"
                    title="Student Name must be more than two character, Numbers&Special Characters are not allowed"
                    required
                    /> 
